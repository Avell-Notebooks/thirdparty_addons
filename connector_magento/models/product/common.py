...
class ProductProduct(models.Model):
    ...
    magento_code = fields.Char(string="Código Magento", )
...
class ProductTemplate(models.Model):
    ...
    magento_code_tmpl = fields.Char(string="Código Magento Notebooks")


class ProductTemplateAttributeValue(models.Model):
    _inherit = 'product.template.attribute.value'

    magento_code_attrs = fields.Char(string="Código Magento")
